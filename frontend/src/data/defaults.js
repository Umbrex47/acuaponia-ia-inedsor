...
export const SENSOR_META = {
  ...
  nitritos: { label: 'Nitritos', unit: 'ppm', color: '#DC2626', min: 0, max: 2, optimal: { min: 0, max: 0.5 } },
  amonio: { label: 'Amonio', unit: 'ppm', color: '#D97706', min: 0, max: 2, optimal: { min: 0, max: 0.5 } },
  fosfatos: { label: 'Fosfatos', unit: 'ppm', color: '#0A0A0A', min: 0, max: 10, optimal: { min: 1, max: 5 } },
  alcalinidad: { label: 'Alcalinidad', unit: 'mg/L', color: '#0A0A0A', min: 0, max: 200, optimal: { min: 50, max: 150 } },
